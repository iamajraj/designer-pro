...
<svelte:head>
	<title>Sign In - DesignerPRO</title>
</svelte:head>
...
<div class="relative min-h-screen w-full overflow-hidden bg-slate-50">
	...
	<div class="relative min-h-screen flex flex-col items-center justify-center py-12 px-4">
		<div class="text-center mb-8">
			...
			<h2 class="mt-2 text-2xl font-semibold text-slate-700">Welcome Back!</h2>
			<p class="mt-2 text-sm text-slate-500">
				Don't have an account?
				<a href="/signup" class="font-medium text-pink-500 hover:text-pink-600 transition-colors">
					Create one now
				</a>
			</p>
		</div>
